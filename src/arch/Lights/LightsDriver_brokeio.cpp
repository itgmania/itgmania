...
void LightsDriver_brokeio::Set(const LightsState* ls) {
  ...
  if (EqualsNoCase(sInputName, "dance")) {
    outputBuffer[BROKEIO_P1_UL] = 
        ls->m_bGameButtonLights[GameController_1][DANCE_BUTTON_UP] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_UR] = 
        ls->m_bGameButtonLights[GameController_1][DANCE_BUTTON_DOWN] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_CN] = 
        ls->m_bGameButtonLights[GameController_1][DANCE_BUTTON_LEFT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_LL] = 
        ls->m_bGameButtonLights[GameController_1][DANCE_BUTTON_RIGHT] ? 0xFF : 0x00;

    outputBuffer[BROKEIO_P2_UL] = 
        ls->m_bGameButtonLights[GameController_2][DANCE_BUTTON_UP] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_UR] = 
        ls->m_bGameButtonLights[GameController_2][DANCE_BUTTON_DOWN] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_CN] = 
        ls->m_bGameButtonLights[GameController_2][DANCE_BUTTON_LEFT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_LL] = 
        ls->m_bGameButtonLights[GameController_2][DANCE_BUTTON_RIGHT] ? 0xFF : 0x00;
  } else if (EqualsNoCase(sInputName, "pump")) {
    outputBuffer[BROKEIO_P1_UL] = 
        ls->m_bGameButtonLights[GameController_1][PUMP_BUTTON_UPLEFT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_UR] = 
        ls->m_bGameButtonLights[GameController_1][PUMP_BUTTON_UPRIGHT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_CN] = 
        ls->m_bGameButtonLights[GameController_1][PUMP_BUTTON_CENTER] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_LL] = 
        ls->m_bGameButtonLights[GameController_1][PUMP_BUTTON_DOWNLEFT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P1_LR] = 
        ls->m_bGameButtonLights[GameController_1][PUMP_BUTTON_DOWNRIGHT] ? 0xFF : 0x00;

    outputBuffer[BROKEIO_P2_UL] = 
        ls->m_bGameButtonLights[GameController_2][PUMP_BUTTON_UPLEFT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_UR] = 
        ls->m_bGameButtonLights[GameController_2][PUMP_BUTTON_UPRIGHT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_CN] = 
        ls->m_bGameButtonLights[GameController_2][PUMP_BUTTON_CENTER] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_LL] = 
        ls->m_bGameButtonLights[GameController_2][PUMP_BUTTON_DOWNLEFT] ? 0xFF : 0x00;
    outputBuffer[BROKEIO_P2_LR] = 
        ls->m_bGameButtonLights[GameController_2][PUMP_BUTTON_DOWNRIGHT] ? 0xFF : 0x00;
  }
